...
REGS: List[RegisterDef] = [
    ...
    RegisterDef(2118, "Compressor operating frequency", "controller reads this register", True, "Hz", 1.0),
    RegisterDef(2119, "Fan motor speed", "controller reads this register", False, "rpm", 1.0),
