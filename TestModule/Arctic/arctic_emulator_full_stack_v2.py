...
REGS: List[Tuple[int, str, str, bool, str, float]] = [
    ...
    (2118, "Compressor operating frequency", "", False, "Hz", 1.0),  # full stack reads this
    (2119, "Fan motor speed", "", False, "rpm", 1.0),                # full stack reads this
    ...
    (2136, "Status register 2", "bitfield; bit5=defrost", False, "", 1.0),  # full stack reads this
...
class DeviceEmulator:
    def __init__(self, unit_id: int, regs: List[Tuple[int, str, str, bool, str, float]]):
        ...
        # One addressing model only: addr+1
    ...
    def get_raw(self, addr: int) -> int:
        # Read from datablock so external Modbus writes are reflected in UI/cache.
        with self._lock:
